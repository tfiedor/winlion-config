...
alias lsc="command ls --color=always --width=(tput cols) -C"
alias lsr="command ls -lrt --color=always"
alias ls="lsc"
...
set PATH "$PATH" "/home/raph/tools/pmc-cloud-tools"
set PATH "$PATH" "/home/raph/tools/msr-cloud-tools"
